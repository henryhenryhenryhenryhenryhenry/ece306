...
void init_serial_UCA3(unsigned int br);//
...
void move_rev(void);//
void test_move(void);//
void spin_n_calibrate(void);//
void follow_line(void);//
void turn_on_to_line(void);//
void turn_off_of_line(void);//
void goto_center(void);//
void continue_till_line(void);//
void proj7(void);//
